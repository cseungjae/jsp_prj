...
<div id="container">
<% 
//POST 방식일때 한글 깨짐을 처리하기 위해 입력되는 문자열의 charset을 encoding 
request.setCharacterEncoding("UTF-8");

//web parameter 받기
//

//<input type="radio"는 여러 개 중에 하나만 선택가능하다. 하나만 parameter로 넘어온다. 
String gender=request.getParameter("gender");

//<input type ="check box"는 여러개가 선택가능하고, 같은 이름으로 여러개의 
//값이 입력된다. => 여러 개의 값을 저장할 수 있게 배열로 받는다. 
