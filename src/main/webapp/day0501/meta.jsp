...
<main>
<div id="container">
접속에 사용하신 URL HTTP:SIST,CO.KR는<br>
2025년 05월 31일 까지 사용됩니다. 이후에는<br>
HTTP://TEST.COM의 URL로만 접속 가능<br>
30초 후 자동으로 HTTP://TEST.COM으로 이동<br>
바로 이동하시려면 <a href="../scheduler/scheduler.jsp"/>
</div>
</main>
