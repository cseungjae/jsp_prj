...
$(function(){
	$('#summernote').summernote({
		 placeholder: '자유롭게 자신의 생각을 작성해주세요',
	        tabsize: 2,
	        height: 240,
	        toolbar: [
	          ['style', ['style']],
...
<input type="hidden" value="${bDTO.num }" />
<table>
<tr>
...
<input type="button" value="글 수정" id="btnModify" class="btn btn-success btn-sm"/>
<input type="button" value="글 삭제" id="btnRemove" class="btn btn-danger btn-sm"/>
</c:if>
<a href="board_list.jsp" class="btn btn-info btn-sm">글 목록</a>
</td>
</tr>
