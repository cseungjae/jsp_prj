...
논리 : ${i > 4 && i < 6 } (${i gt 4 and i lt 6  })
	  ${i > 6 || i < 3 } (${i gt 6 and i lt 3  })<br>	
	  
	  <!--EL에서는 문자가 없다. 문자열을 표현할 때 ",' 모두 사용가능  -->
삼항 : ${i%2==0?"짝수입니다.":"홀수입니다." }, ( ${i mod 2 eq 0 ?"짝수입니다.":'홀수입니다.'} ) 
<br>
<!--scope 객체가 가지고 있는 i 값이 0~10 사이라면 "유효 그렇지 않으면 "무효"를
웹 브라우저에 출력  -->
%{i ge 0 and i le 10 ?"유효":"무효" }
%{i gt -1 and i lt 11 ?"유효":"무효" }<br>
<%
String str=null;//객체가 생성되지 않음.
String str2="";//literal 에 비어있는 값을 할당
...
null 비교 : ${ empty applcationScope.str }<br>
"" 비교 : ${empty str2 }<br>
