...
<c:import url="http://192.168.10.97/jsp_prj/common/jsp/external_file.jsp"/>
<style type="text/css">
...
<header data-bs-theme="dark">
 <c:import url="http://192.168.10.96/jsp_prj/common/jsp/header.jsp"/>
...
String sha256_2=new String(Base64.getEncoder().encode(md3.digest()));
%>
MD5 : <%= md5 %><br>
SHA-1 : <%= sha1 %><br>
SHA-256 : <%= sha256 %><br>
SHA-256_2 : <%= sha256_2 %><br>
<%
//sist_util.jar에 제공
...
<footer class="text-body-secondary py-5">
 <c:import url="http://192.168.10.97/jsp_prj/common/jsp/footer.jsp"/>
