...
<form action="foward_process.jsp" id="frm" name="name" method="get"></form>
<label><%=nameLabel %></label>
<input type="text" name="name" id="name"/><br/>
<label><%=ageLabel %></label>
<input type="text" name="age" id="age"/><br/>
<a href="http://192.168.10.97/jsp_prj/day0507/foward_form.jsp">국내</a>
<a href="http://localhost/jsp_prj/day0507/foward_form.jsp">국외</a>
<br/>
