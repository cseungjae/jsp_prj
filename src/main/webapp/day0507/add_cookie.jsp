...
String chk=request.getParameter("saveFlag");////<input type="checkbox" name="chk"
out.print(chk); //checked되지 않으면 null,vlaue속성이 없는 상태에서 checked되면 "on"
...
if(!name.isEmpty() && !age.isEmpty()){
	...
	cookieSave.setMaxAge(60*60*1);//24h //이름이 1시간이면 맞지 않는다.
