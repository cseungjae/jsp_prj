...
window.onload=function(){
   ...
   document.getElementById("pass").addEventListener("keyup",enter);
...
function chkNull(){
   ...
   obj.submit();//<form 태그에 action이 설정된 페이지로 이동한다.
...
<main class="form-signin w-100 m-auto">
 <form name="loginFrm" method="post" action="login_process.jsp">
  ...
  <button class="btn btn-primary w-100 py-2" type="submit" id="btnLogin">로그인</button>
</form>
